...
struct SettingsView: View {
    ...
    @AppStorage("ladderlog_showNotes") private var showNotes: Bool = true
    @AppStorage("ladderlog_sortNewestFirst") private var sortNewestFirst: Bool = true
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/ladderlog-app/privacy.html")!)
                        .accessibilityIdentifier("settingsPrivacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/ladderlog-app/terms.html")!)
